...
// Components
import { ImpactAnalysisOverviewComponent } from './impact-analysis-overview.component';
...
const routes: Routes = [
	{
		path: '',
		component: ImpactAnalysisOverviewComponent,
	}
];
...
@NgModule({
	...
	declarations: [
		ImpactAnalysisOverviewComponent,
		ImpactAnalysisDetailsComponent
	]
})
export class ImpactAnalysisOverviewModule {}
