...
export class AdGroupsDataSource extends BaseDataSource {
	...
	load(pageNumber: number, pageSize: number, filtro: AdGroup): void
	{
		let filtro2 = null;
		if (filtro != null)
		{
		...
		this.appService.getAllAdGroups(pageNumber + 1, pageSize, filtro2).subscribe((response: QueryResultsModel) => {
