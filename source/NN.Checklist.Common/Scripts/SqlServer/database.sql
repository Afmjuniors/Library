...
CREATE TABLE [PROCESSES](
	...
	[connection_string_alarms] [varchar](1000) NOT NULL,
	[query_alarms] [varchar](8000) NOT NULL,
	[connection_string_events] [varchar](1000) NOT NULL,
	[query_events] [varchar](8000) NOT NULL,
...
CREATE TABLE [USERS_PHONES](
	[user_phone_id] [bigint] IDENTITY(1,1) NOT NULL,
...
ALTER TABLE [AREAS]  WITH CHECK ADD  CONSTRAINT [FK_AREAS_PROCESSES] FOREIGN KEY([process_id])
REFERENCES [PROCESSES] ([process_id]);

ALTER TABLE [AREAS] CHECK CONSTRAINT [FK_AREAS_PROCESSES];
...
ALTER TABLE [USERS_PHONES]  WITH CHECK ADD  CONSTRAINT [FK_USERS_PHONES_COUNTRIES] FOREIGN KEY([country_id])
REFERENCES [COUNTRIES] ([country_id]);

ALTER TABLE [USERS_PHONES] CHECK CONSTRAINT [FK_USERS_PHONES_COUNTRIES];

ALTER TABLE [USERS_PHONES]  WITH CHECK ADD  CONSTRAINT [FK_USERS_PHONES_USERS] FOREIGN KEY([user_id])
REFERENCES [USERS] ([user_id]);

ALTER TABLE [USERS_PHONES] CHECK CONSTRAINT [FK_USERS_PHONES_USERS];
