...
export class RoleOnServerCreated implements Action {
    ...
    constructor(public payload: { role: UserProfile }) { }
}
...
export class RoleUpdated implements Action {
    ...
    constructor(public payload: {
        partialrole: Update<UserProfile>,
        role: UserProfile
    }) { }
}
...
export class RolesPageLoaded implements Action {
    ...
    constructor(public payload: { roles: UserProfile[], totalCount: number, page: QueryParamsModel }) { }
}
...
export class AllRolesLoaded implements Action {
    ...
    constructor(public payload: { roles: UserProfile[] }) { }
}
