...
export class BaseDataSource implements DataSource<BaseModel> {
	...
	pagingSubject = new BehaviorSubject<QueryParamsModel>(new QueryParamsModel(null, null, null, this.defaultPageNumber, this.defaultPageSize));
	paging$: Observable<QueryParamsModel>;
