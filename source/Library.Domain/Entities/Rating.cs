...
{
    public class Rating : DomainBase<Rating, IRatingRepository<Rating, System.Int64>, System.Int64>
    {
        ...
        /// Created by: wazc Programa Novo 2022-09-08 
        /// </summary>
        public Rating(AuthenticatedUserDTO user, int rate, long bookId, string comments)
        {
            UserId = user.UserId;
            Rate = rate;
            BookId = bookId;
        ...
        public System.Int64 RatingId { get; internal set; }
        ...
        public async Task<bool> Validate(AuthenticatedUserDTO user, bool newRecord)
        {
            try
            {
                ...
                if (!newRecord && RatingId <= 0)
                {
                    errors.Add(new DomainError("RatingId", await globalization.GetString(lang, "User001")));
                }
