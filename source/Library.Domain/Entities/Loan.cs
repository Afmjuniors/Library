...
{
    public class Loan : DomainBase<Loan, ILoanRepository<Loan, System.Int64>, System.Int64>
    {
        ...
        /// Created by: wazc Programa Novo 2022-09-08 
        /// </summary>
        public Loan(AuthenticatedUserDTO user, long bookId)
        {
            BorrowerId = user.UserId;
            CreatedBy = user.UserId;
            CreatedAt = DateTime.Now;
            BookId = bookId;
            LoanStatusId = EnumLoanStatus.Pending;
        ...
        public System.Int64 LoanId { get; internal set; }

        [AttributeDescriptor("Created_at", true)]
        public System.DateTime CreatedAt { get; set; }

        [AttributeDescriptor("LoanStatusId", true)]
        public EnumLoanStatus LoanStatusId { get; set; }
        ...
        [AttributeDescriptor("DueDate", false)]
        public DateTime? DueDate { get; set; }
        [AttributeDescriptor("ReceivedDate", false)]
        public DateTime? ReceivedDate { get; set; }
        [AttributeDescriptor("ReturnedDate", false)]
        ...
        public async Task<bool> Validate(AuthenticatedUserDTO user, bool newRecord)
        {
            try
            {
                ...
                if (!newRecord && LoanId <= 0)
                {
                    errors.Add(new DomainError("LoanId", await globalization.GetString(lang, "User001")));
                }
